...
open class TagListView: UIView {
    ...
    open var tagBackgroundColor: UIColor = UIColor(hex: "1a2c60")! {
        didSet {
            for tagView in tagViews {
    ...
    private func rearrangeViews() {
        ...
        textField.attributedPlaceholder = NSAttributedString(string: (tagViews.count == 0 ? "enter search term here" : "add another search term"), attributes: [NSAttributedString.Key.foregroundColor: UIColor(hex: "7886a1")!])
